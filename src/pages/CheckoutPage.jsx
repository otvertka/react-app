    ...
    <section className="mt-20">
      ...
      <div className="flex flex-col md:flex-row md:justify-between mx-10">
        <div className="">
          ...
          <CheckoutInput label="E-mail adress*" type="email" id="email" placeholder="e-mail" />
          <div className="flex">
        ...
        <div className="">
          ...
          <button className="px-5 w-full h-12 rounded-lg bg-orange-600 hover:bg-orange-500 active:bg-orange-700 hover:scale-105 transition-all duration-300 text-white">Подтвердить заказ</button>
        </div>
      </div>
    </section>
  );
