...
const AccsessSinglePage = observer(() => {
  ...
  function handleAddAccessToCart() {
      ...
      <section>
        <div className="grid grid-cols-1 grid-rows-1 lg:grid-cols-1 lg:grid-rows-1 pt-10">
          ...
          <div className="items-center row-end-2 lg:col-end-1 lg:row-span-2 lg:mr-20">
            <img className="w-[790px]" src={selectedAccessory.image} alt="accessory" />
          </div>

          {/*див2 текст */}

          <div className="row-end-1 lg:row-end-1 lg:col-end-2">
            <h2 className="text-3xl md:text-4xl font-medium mb-3">{selectedAccessory.title}</h2>
            <h4 className="mb-3 text-gray-400">{selectedAccessory.brand}</h4>
            <div className="flex justify-between mb-3">
              <h4 className="text-gray-400">Артикул : {selectedAccessory.id}</h4>
          ...
          <div className="lg:col-end-2 lg:row-end-2">
            <div className="flex mb-6 md:mb-10">
              <h2 className="text-4xl font-medium mr-4">{selectedAccessory.price} €</h2>
            ...
            <div className="grid grid-cols-2 grid-rows-2 md:grid-rows-1 md:grid-cols-3 gap-4 mb-12">
              ...
              <div className="col-span-2 md:col-start-2 md:row-start-1">
                <button onClick={handleAddAccessToCart} className=" bg-orange-500 rounded-lg w-[320px] h-[52px] text-white">
                  В корзину
                </button>
              </div>
            </div>
...
export default AccsessSinglePage;
