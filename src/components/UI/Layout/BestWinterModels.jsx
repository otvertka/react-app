  ...
  return (
    <section className="relative bg-black w-full flex">
      ...
      <div className="flex justify-around w-full">
        <img className="z-0 opacity-50 object-cover" src={Splash_l} alt="splash-l" />
        <img className="z-0 opacity-50 object-cover hidden sm:block" src={Splash_r} alt="splash-r" />
      </div>
    </section>
  );
};
